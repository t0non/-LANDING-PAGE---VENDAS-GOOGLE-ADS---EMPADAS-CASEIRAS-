...
const WHATSAPP_ICON_URL = "/icone_whatsapp.png";
  ...
  return (
    <div className="min-h-screen bg-[#FDFCFB] text-stone-900 font-body font-light selection:bg-brand-100 overflow-x-hidden">
      ...
      <nav className="fixed top-0 w-full z-40 bg-white/80 backdrop-blur-xl border-b border-stone-100/50">
        <div className="max-w-screen-2xl mx-auto px-4 lg:px-12 h-20 lg:h-28 flex items-center justify-between">
      ...
      <main className="overflow-x-hidden">
        ...
        <section className="relative pt-24 lg:pt-40 pb-12 lg:pb-24 overflow-hidden">
          <div className="max-w-screen-2xl mx-auto px-6 lg:px-12">
            ...
            {/* Mobile Header (Headline + Subheadline only visible on mobile) */}
            <div className="lg:hidden mb-8">
               <h1 className="text-4xl font-heading font-medium leading-[1.05] text-stone-900 mb-4 tracking-tight">
                  Fornecedor de Empadas <br/><span className="italic text-brand-600 font-normal">Exclusivo no Atacado</span> em BH.
               </h1>
            ...
            <div className="flex flex-col-reverse lg:grid lg:grid-cols-12 gap-8 lg:gap-16 items-center">
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row gap-6">
                    <motion.a 
                      ...
                      whileTap={{ scale: 0.95 }}
                      href={WHATSAPP_LINK}
                      className="hidden sm:flex w-full sm:w-auto items-center justify-center gap-3 bg-brand-600 text-white px-12 py-6 rounded-full font-bold text-sm uppercase tracking-widest hover:bg-brand-700 transition-all shadow-2xl shadow-brand-200"
                    >
                      Solicitar Tabela de Preços
                      <img src={WHATSAPP_ICON_URL} alt="WhatsApp" className="w-8 h-8 object-contain brightness-0 invert" referrerPolicy="no-referrer" />
                    </motion.a>
              ...
              <div className="lg:col-span-5 relative mt-4 lg:mt-0 px-4 lg:px-0 w-full">
                <motion.div 
              ...
              >
                <div className="flex items-center gap-4 mb-10 pb-6 border-b border-stone-50">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-stone-400 font-bold uppercase tracking-widest mt-1">12 Sabores Disponíveis</p>
                  </div>
                </div>
                <ul className="space-y-5">
                  {[
              ...
              <div className="flex flex-col gap-8">
                ...
                >
                  ...
                  <div className="mt-10 pt-6 border-t border-white/10 flex justify-center md:justify-start">
                    <a 
                      href={WHATSAPP_LINK} 
                      className="flex w-full sm:w-auto sm:inline-flex items-center justify-center gap-3 bg-[#25D366] text-white px-8 py-4 rounded-full text-[12px] font-bold uppercase tracking-widest hover:bg-[#1ebe57] transition-all shadow-lg shadow-black/5"
                    >
                      Pedir agora 
                      <img src={WHATSAPP_ICON_URL} alt="WhatsApp" className="w-4 h-4 object-contain brightness-0 invert" referrerPolicy="no-referrer" />
                    </a>
